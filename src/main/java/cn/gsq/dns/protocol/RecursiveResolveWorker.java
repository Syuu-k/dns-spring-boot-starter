...
public class RecursiveResolveWorker extends Thread
{
    ...
    {
        Response response = recursiveResolver.takeResponse();
        ...
        if (msg.answerRRs == 0)
        {
            ...
            nameServer.putResponse(new Response(response.remoteAddress, packet.getBytes()));
            return;
        }
        ...
        nameServer.putResponse(new Response(response.remoteAddress, resp));
    }
